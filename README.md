...
[![GitHub license](https://img.shields.io/badge/license-GPLv3-blue.svg?style=square)](https://github.com/dfuchss/rekit-sample-mod/blob/master/LICENSE.md)

[R&#949;​KiT](https://github.com/dfuchss/rekit-game) is a platform jumper game entirely written in Java with [AWT](https://docs.oracle.com/javase/8/docs/api/java/awt/package-summary.html).
...
* Mark class for loading via `@LoadMe` (see [API-Docs](https://dfuchss.github.io/rekit-game/))
